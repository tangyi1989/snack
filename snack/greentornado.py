...
"""
Reference : https://github.com/vishnevskiy/greentornado

Allows Eventlet to run on top of Tornado's IOLoop.
If you want to use Eventlet without using greentornado.greenify you 
have to call eventlet.hubs.use_hub(greentornado.Hub) manually.
